...
abstract final class AppTheme {
  static ThemeData lightTheme = ThemeData(
      ...
      colorScheme: ColorScheme.fromSeed(
          seedColor: AppColors.white, secondary: AppColors.black),
      ...
      tabBarTheme: TabBarThemeData(
        labelStyle: TextStyle(
            fontWeight: FontWeight.w700, fontSize: 16, color: AppColors.black),
  ...
  static ThemeData darkTheme = ThemeData(
      ...
      colorScheme: ColorScheme.fromSeed(
          seedColor: AppColors.black, secondary: AppColors.white),
      appBarTheme: AppBarTheme(
          centerTitle: true,
      ...
      tabBarTheme: TabBarThemeData(
        ...
        labelStyle: TextStyle(
            fontWeight: FontWeight.w700, fontSize: 16, color: AppColors.white),
        unselectedLabelStyle: TextStyle(
